...
const ProcessSidebar = () => {
  return (
    <TextContainer>
      ...
      <SmallText>Simultaneously, tools and tool-making play an inextricable role in my design process (<Link to='works/vector-spin-stroke'>my capstone project on tools</Link>). Given each tool’s particular performances and mechanisms, they stand between the designer and their outputs, setting the conditions within each investigation. In my case, to approach a situation from the ground up often involves making my own tools. Whether it be digital (coded, generative, algorithmic) or <Link to='work/stroke'>analog</Link> (tactile, haptic, tangible), they offer their own ways of assessing a given problem. In other words, tools are <i>potential openings to design challenges—through which new modes of thinking and making could emerge.</i></SmallText>
    </TextContainer>
  )
}
